...
if (isset($_SESSION['period_start_date']))
    unset($_SESSION['period_start_date']);

if (isset($_SESSION['period_end_date']))
    unset($_SESSION['period_end_date']);
?>
    ...
    <div class="container">
            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <div class="text-end">
                        ...
                        <a href="sign_up.php" role="button" class="btn btn-warning">Sign-up</a>
                    </div>
                </div>
            </div>
        </header>
        <div class="py-5 p-4 my-4 text-center border border-dark rounded col-lg-8 mx-auto" id="heroes">
            ...
            <div class="col-lg-6 mx-auto">
                <p class="lead mb-4">This application will help you manage your budget. You can add expenses, revenues
                    and check
                    the balance for any period on an ongoing basis. Registration and subsequent logging in at any time
                    will allow
                    you to conveniently access your data. I keep my fingers crossed that the balance will always be
                    positive :)</p>
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                <a href="balance_view.php" role="button" class="btn btn-light btn-lg" data-mdb-ripple-init
